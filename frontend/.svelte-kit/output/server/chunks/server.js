...
function setContext(key, context) {
	...
	if (ssr_context.i) set_context_after_init();
...
//#endregion
export { set as $, get as A, EFFECT_PRESERVED as At, move_effect as B, run as Bt, lifecycle_function_unavailable as C, set_hydrating as Ct, is_passive_event as D, svelte_boundary_reset_noop as Dt, escape_html as E, lifecycle_double_unmount as Et, branch as F, array_from as Ft, create_element as G, render_effect as H, component_root as I, define_property as It, get_next_sibling as J, create_text as K, destroy_effect as L, fallback as Lt, set_active_reaction as M, LEGACY_PROPS as Mt, untrack as N, REACTION_RAN as Nt, active_effect as O, ATTACHMENT_KEY as Ot, block as P, safe_not_equal as Pt, mutable_source as Q, effect_root as R, noop as Rt, hydratable_serialization_failed as S, set_hydrate_node as St, clsx$1 as T, hydration_mismatch as Tt, invoke_error_boundary as U, pause_effect as V, to_array as Vt, clear_text_content as W, increment as X, init_operations as Y, internal_set as Z, getContext as _, experimental_async_required as _t, derived as a, defer_effect as at, ssr_context as b, hydrating as bt, head as c, mark_as_component as ct, spread_props as d, set_component_context as dt, source as et, stringify as f, tag as ft, getAllContexts as g, svelte_boundary_reset_onerror as gt, createContext as h, rune_outside_svelte as ht, bind_props as i, without_reactive_context as it, set_active_effect as j, EFFECT_TRANSPARENT as jt, active_reaction as k, HYDRATION_ERROR as kt, props_id as l, pop$1 as lt, get_render_context as m, hydration_failed as mt, attr_style as n, current_batch as nt, element as o, queue_micro_task as ot, get_user_code_location as p, async_mode_flag as pt, get_first_child as q, attributes as r, flushSync as rt, ensure_array_like as s, component_context as st, attr_class as t, Batch as tt, render as u, push$1 as ut, hasContext as v, hydrate_next as vt, attr as w, skip_nodes as wt, hydratable_clobbering as x, next as xt, setContext as y, hydrate_node as yt, effect_tracking as z, object_keys as zt };
