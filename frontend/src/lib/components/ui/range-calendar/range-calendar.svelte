...
<RangeCalendarPrimitive.Root
	...
	class={cn(
		"p-3 [--cell-radius:var(--radius-2xl)] [--cell-size:--spacing(8)] group/calendar bg-background p-3 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
		className
	)}
	{locale}
	{monthFormat}
